# defmodule Finch.Middleware.Authenticator do
#   @verbs [:create, :show, :index, :destroy, :update]
#   import Ecto.Query, only: [from: 2]

#   def authenticate({verb, conn, params, module, bundle}) do
#     try do
...
#       for verb <- only do
#         def handle({unquote(verb), conn, params, module, bundle}), do: Finch.Middleware.Authenticator.authenticate({unquote(verb), conn, params, module, bundle})
#       end
